...
export default function Carousel() {
  return (
    <div className="carousel-vertical">
      <figure className="figure-social flex box-shadow">
        ...
        <div className="bg-image logo block lg:hidden" style={{backgroundImage: 'url(/images/steem-retrogames-mobile.png)'}}></div>
        <div className="bg-image logo hidden lg:block" style={{backgroundImage: 'url(/images/steem-retrogames.png)'}}></div>
      </figure>
      ...
      <figure className="figure-social flex box-shadow">
        ...
        <div className="bg-image logo block lg:hidden" style={{backgroundImage: 'url(/images/steematlas-mobile.png)'}}></div>
        <div className="bg-image logo hidden lg:block" style={{backgroundImage: 'url(/images/steematlas.png)'}}></div>
      </figure>
      ...
      <figure className="figure-social flex box-shadow">
        ...
        <div className="bg-image logo block lg:hidden" style={{backgroundImage: 'url(/images/SteemIt-Mobile.jpg)'}}></div>
        <div className="bg-image logo hidden lg:block" style={{backgroundImage: 'url(/images/SteemIt.jpg)'}}></div>
      </figure>
      ...
      <figure className="figure-social flex box-shadow">
        ...
        <div className="bg-image logo block lg:hidden" style={{backgroundImage: 'url(/images/hari-raid-logo-mobile.webp)'}}></div>
        <div className="bg-image logo hidden lg:block" style={{backgroundImage: 'url(/images/hari-raid-logo.webp)'}}></div>
      </figure>
    </div>
  );
}
