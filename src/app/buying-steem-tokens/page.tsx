              ...
              <div className="w-full md:w-1/2 lg:w-5/12 xl:w-1/3">
                <div className="nomargin-container text-white">
                  ...
                  <p className="text-lg mb-6 leading-relaxed">
                    Get to know the three types of Steem tokens and where to
                    buy, sell, and earn them.
                  </p>
              ...
              <div>
                <div className="py-xl-3">
                  ...
                  <p className="text-lg mb-4 leading-relaxed">
                    Steem enables social networks to be placed on a blockchain
                    with cryptocurrency so users can get paid for contributing
                    good content.
                  </p>
                  <p className="text-lg leading-relaxed">
                    The Steem Blockchain contains three unique tokens with three
                    different attributes. Whether you want to increase your
                    social app influence, HODL wisely, or zero in on cash,
                    there&apos;s a Steem token for you.
                  </p>
                </div>
              </div>
              <div>
                <div className="space-y-4">
                  <div className="flex items-center border-rounded box-shadow bg-white p-4">
                    ...
                    />
                    <div>
                      <h3 className="mb-1 text-blue text-xl font-bold">
                        Steem
                      </h3>
                      <p className="mb-1 text-grey">
                        Liquid token for short term traders
                      </p>
                      <Link
                        href="/faq/#what-can-i-do-with-my-steem-tokens"
                        className="a-underline text-lightblue"
                      >
                        Find out more
                      </Link>
                    </div>
                  ...
                  <div className="flex items-center border-rounded box-shadow bg-white p-4">
                    ...
                    <div>
                      ...
                      <p className="mb-1 text-grey">
                        Vesting token for HODLers
                      </p>
                      <Link
                        href="/faq/#what-is-a-mvest"
                        className="a-underline text-lightblue"
                      >
                        Find out more
                      </Link>
                  ...
                  <div className="flex items-center border-rounded box-shadow bg-white p-4">
                    ...
                    <div>
                      ...
                      <p className="mb-1 text-grey">
                        Stablecoin that seeks price stability to USD
                      </p>
                      <Link
                        href="/faq/#what-can-i-do-with-my-sbd-tokens"
                        className="a-underline text-lightblue"
                      >
                        Find out more
                      </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="text-center">
                <div className="px-lg-3">
                  ...
                  <p className="text-grey mb-4">
                    Get rewarded with free Steem tokens for creating and
                    curating content on Steem-based social apps like Steemit,
                    DTube, and Utopian.
                  </p>
                  <Link
              ...
              <div className="text-center">
                <div className="px-lg-3">
                  ...
                  <p className="text-grey mb-4">
                    No Steem account? No problem. Steem-based tokens are listed
                    on some of the biggest exchanges in the world, like Binance,
                    Bittrex, Upbit, and GOPAX.
                  </p>
                  <Link
