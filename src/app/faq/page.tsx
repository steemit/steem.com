            ...
            <section className="bg-wave py-7 lg:py-8 xl:py-10">
              ...
              <div className="col-lg-5 col-xl-4 position-relative">
                <div id="questions" className="scroll-container">
                  ...
                  <ul>
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#how-do-i-use-cli_wallet">How do I use cli_wallet?</a>
                      </p>
                    </li>
                    <li>
                      <p className="mb-2 small text-grey">
                    ...
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#how-is-steem-different-from-bitcoin">How is Steem different from Bitcoin?</a>
                      </p>
                    </li>
                    <li>
                      <p className="mb-2 small text-grey">
                    ...
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#what-is-the-steem-blockchain">What is the Steem blockchain?</a>
                      </p>
                    </li>
                  </ul>
                  ...
                  <ul>
                    ...
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#will-i-get-a-1099-from-steemit">Will I get a 1099 from Steemit?</a>
                      </p>
                    </li>
                    <li>
                      <p className="mb-2 small text-grey">
                    ...
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#what-can-i-do-with-my-sbd-tokens">What can I do with my SBD tokens?</a>
                      </p>
                    </li>
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#what-can-i-do-with-my-steem-tokens">What can I do with my STEEM tokens?</a>
                      </p>
                    </li>
                  </ul>
                  ...
                  <ul>
                    ...
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#what-are-my-different-keys-for">What are my different keys for?</a>
                      </p>
                    </li>
                    <li>
                      <p className="mb-2 small text-grey">
                  ...
                  <ul>
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#how-can-i-vote-for-witnesses">How can I vote for witnesses?</a>
                      </p>
                    </li>
                    <li>
                      <p className="mb-2 small text-grey">
                        <a href="#what-are-steem-witnesses">What are Steem witnesses?</a>
                      </p>
                    </li>
                  </ul>
                </div>
              ...
              <div className="col-lg-6 col-xl-7 offset-lg-1">
                <div id="answers" className="scroll-container">
                  ...
                  <p id="how-do-i-use-cli_wallet" className="font-weight-700 mt-5 mb-3">
                    How do I use cli_wallet?
                  </p>
                  <div className="small-container">
                    <p>
                      Here is a guide from the user{' '}
                      <a href="https://steemit.com/@pfunk" target="_blank" rel="noopener noreferrer">
                        @pfunk
                      </a>{' '}
                  ...
                  <p id="can-i-mine-steem" className="font-weight-700 mt-5 mb-3">
                    Can I mine STEEM?
                  </p>
                  <div className="small-container">
                    <p>No. Proof of work mining has been removed from Steem.</p>
                  </div>

                  <p id="where-can-i-find-the-information-for-the-official-launch-of-the-blockchain" className="font-weight-700 mt-5 mb-3">
                    Where can I find the information for the official launch of the blockchain?
                  </p>
                  <div className="small-container">
                    <p>
                      The original launch of Steem was on March 23, 2016, announced on{' '}
                      <a href="https://bitcointalk.org/index.php?topic=1408726.0" target="_blank" rel="noopener noreferrer">
                        Bitcointalk.org
                      </a>
                      . The blockchain launched on March 24, 2016, via{' '}
                      <a href="https://bitcointalk.org/index.php?topic=1410943.0" target="_blank" rel="noopener noreferrer">
                        Bitcointalk.org
                      </a>
                      .
                    </p>
                  ...
                  <p id="is-there-a-way-to-see-the-raw-data-that-is-stored-in-the-blockchain" className="font-weight-700 mt-5 mb-3">
                    Is there a way to see the raw data that is stored in the blockchain?
                  </p>
                  <div className="small-container">
                    <p>
                      Yes. The blockchain data can be viewed in different ways with third-party tools such as{' '}
                      <a href="https://steemd.com/" target="_blank" rel="noopener noreferrer">
                        steemd.com
                      </a>{' '}
                      and{' '}
                      <a href="https://steemdb.com/" target="_blank" rel="noopener noreferrer">
                        steemdb.com
                      </a>
                      .
                    </p>
                  ...
                  <p id="how-often-does-the-steem-blockchain-produce-a-new-block" className="font-weight-700 mt-5 mb-3">
                    How often does the Steem blockchain produce a new block?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-is-the-difference-between-proof-of-work-proof-of-stake-and-delegated-proof-of-stake" className="font-weight-700 mt-5 mb-3">
                    What is the difference between Proof of Work, Proof of Stake, and Delegated Proof of Stake?
                  </p>
                  <div className="small-container">
                    <p>
                      <strong>Proof of work</strong> – Miners solve a complex mathematical problem. The miner that solves the problem first adds the block to the blockchain. The network rewards the miner for doing so.
                    </p>
                    <p>
                      <strong>Proof of stake</strong> – Requires ownership, or stake, in the cryptocurrency. The more tokens you own, the more block creation power you have. Benefits: eliminates the need for expensive mining rigs, runs on a tiny fraction of the power, and it requires block producers to have a stake in the network.
                    </p>
                    <p>
                      <strong>Delegated proof of stake</strong> – Block-creating accounts, called witnesses, are collectively approved by Steem stakeholders. Instead of relying on proof of work to find blocks, the Steem network actively schedules these accounts to improve the time between blocks to 3 seconds.
                    </p>
                  </div>

                  <p id="how-is-steem-different-from-bitcoin" className="font-weight-700 mt-5 mb-3">
                  ...
                  <p id="what-is-the-difference-between-steem-and-steemit" className="font-weight-700 mt-5 mb-3">
                    What is the difference between Steem and Steemit?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="how-does-bandwidth-work-on-the-steem-blockchain" className="font-weight-700 mt-5 mb-3">
                    How does bandwidth work on the Steem blockchain?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-is-the-steem-blockchain" className="font-weight-700 mt-5 mb-3">
                  ...
                  <h3 id="Developers" className="text-lightblue mt-4 mt-md-5 mb-3">
                    Developers
                  </h3>

                  <p id="what-is-available-for-developers-interested-in-steem" className="font-weight-700 mt-5 mb-3">
                    What is available for developers interested in Steem?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="is-there-a-github-page-for-the-steem-blockchain" className="font-weight-700 mt-5 mb-3">
                    Is there a Github page for the Steem blockchain?
                  </p>
                  <div className="small-container">
                    <p>
                      Yes, the Steem blockchain code is available on GitHub at{' '}
                      <a href="https://github.com/steemit/steem" target="_blank" rel="noopener noreferrer">
                  ...
                  <p id="are-the-steem-blockchain-and-steemit-com-code-open-source" className="font-weight-700 mt-5 mb-3">
                    Are the Steem blockchain and steemit.com code open-source?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <h3 id="Economics" className="text-lightblue mt-4 mt-md-5 mb-3">
                    Economics
                  </h3>

                  <p id="where-do-the-new-steem-tokens-come-from" className="font-weight-700 mt-5 mb-3">
                    Where do the new STEEM tokens come from?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="how-long-does-it-take-to-transfer-steem-or-sbd-tokens-between-users" className="font-weight-700 mt-5 mb-3">
                    How long does it take to transfer STEEM or SBD tokens between users?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="are-there-fees-for-powering-up-powering-down-trading-on-the-internal-market-or-converting-sbd-to-steem" className="font-weight-700 mt-5 mb-3">
                    Are there fees for Powering Up, Powering Down, trading on the internal market, or converting SBD to STEEM?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="how-much-are-the-transaction-fees-for-sending-tokens-to-other-users" className="font-weight-700 mt-5 mb-3">
                    How much are the transaction fees for sending tokens to other users?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="will-i-get-a-1099-from-steemit" className="font-weight-700 mt-5 mb-3">
                  ...
                  <p id="how-can-i-withdraw-my-steem-or-sbd-coins" className="font-weight-700 mt-5 mb-3">
                    How can I withdraw my STEEM or SBD coins?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="can-i-sell-goods-and-services-on-steemit" className="font-weight-700 mt-5 mb-3">
                    Can I sell goods and services on Steemit?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-is-a-mvest" className="font-weight-700 mt-5 mb-3">
                    What is a MVEST?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-can-i-do-with-my-sbd-tokens" className="font-weight-700 mt-5 mb-3">
                  ...
                  <p id="what-can-i-do-with-my-steem-tokens" className="font-weight-700 mt-5 mb-3">
                  ...
                  <h3 id="Security" className="text-lightblue mt-4 mt-md-5 mb-3">
                    Security
                  </h3>

                  <p id="how-do-i-report-a-security-vulnerability" className="font-weight-700 mt-5 mb-3">
                    How do I report a security vulnerability?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="how-does-the-stolen-account-recovery-process-work" className="font-weight-700 mt-5 mb-3">
                    How does the stolen account recovery process work?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-should-i-do-if-i-discover-that-someone-hacked-my-account" className="font-weight-700 mt-5 mb-3">
                    What should I do if I discover that someone hacked my account?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="are-my-steem-and-steem-dollar-tokens-insured-in-the-event-of-a-hack-or-if-someone-takes-over-my-account" className="font-weight-700 mt-5 mb-3">
                    Are my STEEM and Steem Dollar tokens insured in the event of a hack or if someone takes over my account?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-do-i-do-if-i-lost-my-password-keys" className="font-weight-700 mt-5 mb-3">
                    What do I do if I lost my password/keys?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="what-are-my-different-keys-for" className="font-weight-700 mt-5 mb-3">
                  ...
                  <p id="why-is-the-master-password-a-long-string-of-gibberish" className="font-weight-700 mt-5 mb-3">
                    Why is the master password a long string of gibberish?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="why-should-i-be-careful-with-my-master-password" className="font-weight-700 mt-5 mb-3">
                    Why should I be careful with my master password?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <p id="how-can-i-keep-my-steem-account-secure" className="font-weight-700 mt-5 mb-3">
                    How can I keep my Steem account secure?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <h3 id="General" className="text-lightblue mt-4 mt-md-5 mb-3">
                    General
                  </h3>

                  <p id="where-can-i-ask-for-help-if-my-question-was-not-answered-here" className="font-weight-700 mt-5 mb-3">
                    Where can I ask for help if my question was not answered here?
                  </p>
                  <div className="small-container">
                    <p>
                      You can ask for help on the Steemit platform, join the official Steem Discord or Slack channels, or visit the{' '}
                      <a href="https://steemit.com/steemhelp" target="_blank" rel="noopener noreferrer">
                        SteemHelp
                      </a>{' '}
                      community.
                    </p>
                  ...
                  <p id="what-is-the-steem-whitepaper-and-what-is-its-purpose" className="font-weight-700 mt-5 mb-3">
                    What is the Steem Whitepaper and what is its purpose?
                  </p>
                  <div className="small-container">
                    <p>
                  ...
                  <h3 id="Witnesses" className="text-lightblue mt-4 mt-md-5 mb-3">
                    Witnesses
                  </h3>

                  <p id="how-can-i-vote-for-witnesses" className="font-weight-700 mt-5 mb-3">
                  ...
                  <p id="what-are-steem-witnesses" className="font-weight-700 mt-5 mb-3">
